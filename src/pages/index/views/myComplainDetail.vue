    ...
    <div class="detail-con-wrap">
      <div class="inner">
        <div class="crumb f14 c999">
          ...
          <span>旅游服务</span>
          <span>></span>
          <span class="active">我的投诉详情</span>
        </div>
        <div class="detail-wrap bcfff">
          <div class="detail-head">
            <div class="detail-title c333 f24">{{info.title}}</div>
            <div class="detail-tip clearfix">
              <span class="time fl c999 f14">投诉时间:{{info.createTime}}</span>
              <div class="share fl">
          ...
          <div class="detail-cont">
            <div class="detail-cont-title f18 c333 fb">投诉内容</div>
...
.detail-wrap .detail-head .detail-title {
  ...
  line-height: 37px;
  padding-left: 43px;
  background: url("../../../assets/img/person/complain-icon.png") left center
    no-repeat;
}
